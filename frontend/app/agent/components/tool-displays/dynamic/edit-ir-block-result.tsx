        ...
        <div className="flex items-center gap-1.5 text-sm">
          {parsed.success ? (
            <>
              ...
              <span className="text-green-600 dark:text-green-400">Block updated successfully</span>
            </>
          ) : (
            <>
              <XCircle className="size-3.5 text-red-500" />
              <span className="text-red-600 dark:text-red-400">{parsed.error || 'Update failed'}</span>
            </>
          )}
        </div>
      )}
